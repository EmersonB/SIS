...
class Card2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        get(url: "/report_card/", completionHandler: { data in
            //            print(data)
            //String : AnyObject
    ...
    func addCard(course: [String: AnyObject]){
        ...
        let cardContentVC = storyboard!.instantiateViewController(withIdentifier: "Card2Content") as! Card2ContentViewController
